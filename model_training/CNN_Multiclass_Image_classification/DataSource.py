...
#%%
def get_dog_images(breed, count=200, type='train'):
...
get_dog_images('English Mastiff')
get_dog_images('Husky')
#%% get test images
get_dog_images('affenpinscher', type='test', count=40)
get_dog_images('corgi', type='test', count=40)
get_dog_images('akita', type='test', count=40)
get_dog_images('English Mastiff', type='test', count=40)
get_dog_images('Husky', type='test', count=40)
